...
public class RecordQueryDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_record_query_detail);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        Bundle scoreBundle = getIntent().getExtras();
        List<Map<String, Object>> score_data = ((SerializableList) scoreBundle.get("score_data")).getList();
        GPA = scoreBundle.getString("GPA");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_record_query_detail, menu);
        return true;
    }
    ...
    private void setListView(List<Map<String, Object>> score) {
        ListView li = findViewById(R.id.record_query_detail_list);
        SimpleAdapter Adapter = new SimpleAdapter(this, score,
                R.layout.listview_record_query_detail,
    ...
    final static int[] SCORE_COLORS = {R.color.red, R.color.yellow, R.color.green, R.color.side_nav_bar, R.color.purple};
