...
public class MainTempActivity extends LoginNetworkActivity {
...
//        checker = new VersionCheckerTask(getString(R.string.UpdateAddress), this);
...
//        checker.check(((MyApplication) getApplication()).CheckNetwork());
        ...
        setErrorHandler(new ErrorHandler() {
            ...
            public void onPasswordError() {
                cancelProcessDialog();
                Toast.makeText(MainTempActivity.this, R.string.errorPassword, Toast.LENGTH_LONG).show();
            }
            @Override
            public void onTimeoutError() {
                cancelProcessDialog();
                Toast.makeText(MainTempActivity.this, R.string.connectionTimeout, Toast.LENGTH_LONG).show();
            }
        });
    }
...
//                Toast.makeText(MainTempActivity.this, R.string.pressAgainToExit, Toast.LENGTH_SHORT).show();
//            } else {
//                finish();
//            }
//            lastDown = nowDown;
...
//            Intent setting = new Intent(MainTempActivity.this, Settings.class);
...
//                                    StoreData sd = new StoreData(MainTempActivity.this);
//                                    sd.clearTable();
//                                    sd.close();
//                                    Login(new LoginDialog(LoginDialog.LoginEle), "ELE", 0x104);
//                                }
...
//                Intent through_out = new Intent(MainTempActivity.this, Timetable.class);
        ...
        switch (what) {
            case 0x101://本科教学网首页 	get
                ...
                if (str_msg != null) {
                    ...
                    WebNotificationFragment fragment = new WebNotificationFragment();
...
//                    } else {
//                        Toast.makeText(MainTempActivity.this, R.string.error_obtain_ip, Toast.LENGTH_LONG).show();
//                    }
//                    break;
            case 0x107://login to 202.204.48.66 success feedback;  post
                savePasswordToLocal();
                Toast.makeText(MainTempActivity.this, R.string.net_sign_in_success, Toast.LENGTH_SHORT).show();
...
//                case 0x001:
//                    cancelProcessDialog();
//                    Toast.makeText(MainTempActivity.this, R.string.importsuccess, Toast.LENGTH_SHORT).show();
//                    TodayCourseFragment fragment = new TodayCourseFragment(); //show new timetable after imported
//                    getFragmentManager().beginTransaction().replace(R.id.main_container, fragment).commit();
//                    break;
//                case 0x002:
//                    cancelProcessDialog();
//                    Toast.makeText(MainTempActivity.this, R.string.importfail, Toast.LENGTH_SHORT).show();
//                    break;
//                case 0x003: // show new version dialog
//                    showUpdate(checker.versionCode, checker.versionNameNew, checker.packageSize, checker.versionDescribe);
//                    break;
//            }
//        }
//    };
...
//                @Override
//                public void run() {
//                    StoreData store_data = new StoreData(MainTempActivity.this);
...
//                    @Override
//                    public void onClick(DialogInterface dialog, int which) {
//                        Toast.makeText(MainTempActivity.this, R.string.update_downloading, Toast.LENGTH_SHORT).show();
//                        Intent intent = new Intent(MainTempActivity.this, DownloadApk.class);
...
//            main_google_progress_bar = findViewById(R.id.main_google_progress_bar);
//        }
